vim = vim -- HACK: Supress uninitialized global variable
vim.g.mapleader = ' '
...
vim.keymap.set('n', '<Tab>', '<cmd>cnext<CR>', { desc = 'Move next in quickfix' })
vim.keymap.set('n', '<S-tab>', '<cmd>cprev<CR>', { desc = 'Move previous in quickfix' })
